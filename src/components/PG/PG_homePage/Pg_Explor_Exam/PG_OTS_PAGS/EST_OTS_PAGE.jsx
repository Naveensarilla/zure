  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: " #000", height: "9vh" }}>
        <h1>ESE - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">

          <h2>ESE - ONLINE TEST SERIES - 2024</h2>

          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
          The Engineering Services Examination (ESE) is a prestigious exam
          conducted for recruiting engineers to various services under the
          Government of India. ESE offers opportunities for engineering
          graduates in fields like Civil Engineering, Mechanical Engineering,
          Electrical Engineering, and Electronics & Telecommunication
          Engineering. Diligent preparation and exceptional performance in the
          ESE exam are crucial goals for engineering aspirants. The ESE Online
          Test Series, provided by eGRADTutor academy, proves to be an
          invaluable resource for students. It allows them to assess their
          knowledge and comprehension of engineering subjects before facing the
          actual examination. Our online test series not only reinforces your
          understanding but also provides challenges in an environment closely
          resembling the final ESE examination. eGRADTutor academy offers a
          comprehensive set of resources, including previous year question
          papers and online test series tailored specifically for ESE aspirants.
          The online test series replicates the ESE exam interface, empowering
          students to strategize and approach the examination with confidence.
          Practicing with our test series enhances aspirants' preparation,
          significantly improving their prospects of success in the ESE exam and
          securing roles in various engineering services.
        </p>
      </div>
        ...
        <div className="jeesection">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                ESE online test series is crafted by academic experts with years
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                ESE online test series lets you have a real-time exam
        ...
        <div className="whyonline_ots">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li id="FEATURES-OTS">
              ...
              <p>Developed as per the latest syllabus of ESE exam.</p>
            </li>
            <li id="FEATURES-OTS">
              <span className="card2_-img">

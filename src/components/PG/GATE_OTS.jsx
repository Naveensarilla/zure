...
<div className='coursename ots-conatiner'>
    <h1>GATE_OTS - ONLINE TEST SERIES</h1>
</div>
<div className='contentug_OTS ots-conatiner'>

<div className='coursebrochure'>
<h3>GATE_OTS - ONLINE TEST SERIES - 2023 </h3>
...
<div className='table ots-conatiner'>
    <h3>BUY ONLINE TEST SERIES</h3>
      ...
      <table id="customers">
         ...
         <tr>
            <td>2</td>
            <td>Challenger Test Series (GATE_OTS)</td>
...
<div className='SCHEDULE ots-conatiner'>
    <h3>GATE_OTS-TEST SERIES SCHEDULE</h3>
    <div class="button-contant-ug" >
        ...
        <button class="button2 otsNavLinks" onclick="">GATE_OTS - Mathematics</button>
    
        <button class="button2 otsNavLinks" onclick="">GATE_OTS - Physics</button>
        
        <button class="button2 otsNavLinks" onclick="">GATE_OTS - Chemistry</button>
    </div>
    </div>
    <div className='Features ots-conatiner'>
        ...
        <ul>
            ...
            <li>Developed as per the latest syllabus of GATE_OTS exam.</li>
            <li>All the tests will be accessible till the GATE_OTS examination.</li>
            ...
            <li>Gives you sufficient time to consolidate on your  GATE_OTS Advanced preparation.</li>
            ...
            <li>Same pattern and time limit as the actual GATE_OTS exam which acquaints students with the intricacies of the exam.</li>
            <li>Gives you several chances to appear in simulated GATE_OTS like environment to help you develop better time management skills.</li>

  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: "#000", height: "9vh" }}>
        <h1> TS EAMCET - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">
          <h2> TS EAMCET - ONLINE TEST SERIES - 2024</h2>
          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
          TS EAMCET stands for Telangana State Engineering, Agriculture, and
          Medical Common Entrance Test. It is a computer-based examination
          ...
          different campuses in Telangana. Aspirants aim to prepare thoroughly
          and perform well in this entrance examination to fulfill their
          academic goals. To assist students in their preparation journey, TS
          EAMCET Online Test Series is designed to evaluate their learning and
          ...
          Academy is committed to supporting TS EAMCET aspirants by providing
          ...
          preparation, challenge yourself, and achieve success in the TS EAMCET.
        </p>
      </div>
...
TS EAMCET online test series is crafted by academic experts with
...
TS EAMCET online test series lets you have a real-time exam
        ...
        <div className="whyonline_ots">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li id="FEATURES-OTS">
              ...
              <p>Developed as per the latest syllabus of TS-EAMCET exam.</p>
            </li>
            <li id="FEATURES-OTS">
              <span className="card2_-img">

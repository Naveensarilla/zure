  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: "#000", height: "9vh" }}>
        <h1>MET - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">
          <h2>MET  - ONLINE TEST SERIES - 2024</h2>
          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
          
MET Exam stands for Manipal Entrance Test. It is a computer-based examination conducted for students seeking admission into various undergraduate programs, BTech courses, offered at different campuses in Manipal. Aspirants aspire to prepare thoroughly and perform well in this entrance examination to fulfill their academic goals and secure admission into Manipal Academy of Higher Education.

To assist students in their preparation journey, MET Exam Online Test Series is designed to evaluate their learning and comprehension levels before facing the actual entrance exam. Our online test series serves as a platform for students to strengthen their understanding of the subjects and test their knowledge in an environment closely resembling the final examination.

eGRADTutor Academy is committed to supporting MET Exam aspirants by providing access to previous year question papers and comprehensive online test series. The test series interface mirrors the actual exam setup, empowering students to develop effective strategies and approach the examination with confidence. Join our academy to enhance your preparation, challenge yourself, and achieve success in the MET Exam.
        </p>
      </div>
      ...
      <div className="jeesection">
        ...
        <ul className="FEATURES_-contant">
          ...
          <li style={{ alignItems: "center" }}>
            ...
            <p>
            MET  online test series is crafted by academic experts with
          ...
          <li style={{ alignItems: "center" }}>
            ...
            <p>
            MET  online test series lets you have a real-time exam
...
<div className="FEATURES_Bgcolor">
        ...
        <ul className="FEATURES_-contant">
          ...
          <p>
          Developed as per the latest syllabus of MET exam.
          </p>
          </li>
          <li id="FEATURES-OTS">
              <span className="card2_-img">

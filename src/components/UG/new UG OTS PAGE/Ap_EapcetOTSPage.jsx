  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: "#000", height: "9vh" }}>
        <h1>AP EAPCET - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">
          <h2>AP EAPCET - ONLINE TEST SERIES - 2024</h2>
          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
          AP EAPCET stands for Andhra Pradesh Engineering, Agriculture, and
          Pharmacy Common Entrance Test. It is a computer-based examination
          conducted for students seeking admission into various undergraduate
          programs, including Engineering, Medicine and Agriculture., offered at
          different campuses in Andhra Pradesh. Aspirants aspire to prepare
          thoroughly and perform well in this entrance examination to fulfill
          their academic goals. To assist students in their preparation journey,
          AP EAPCET Online Test Series is designed to evaluate their learning
          and comprehension levels before facing the actual entrance exam. Our
          online test series serves as a platform for students to strengthen
          their understanding of the subjects and test their knowledge in an
          environment closely resembling the final examination. eGRADTutor
          Academy is committed to supporting AP EAPCET aspirants by providing
          access to previous year question papers and comprehensive online test
          series. The test series interface mirrors the actual exam setup,
          empowering students to develop effective strategies and approach the
          examination with confidence. Join our academy to enhance your
          preparation, challenge yourself, and achieve success in the AP EAPCET.
        </p>
      </div>
        ...
        <div className="jeesection">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
              AP EAPCET online test series is crafted by academic experts with
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
              AP EAPCET online test series lets you have a real-time exam
        ...
        <div className="whyonline_ots">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li id="FEATURES-OTS">
              ...
              <p>Developed as per the latest syllabus of AP-EAPCET exam.</p>
            </li>
            <li id="FEATURES-OTS">
              <span className="card2_-img">

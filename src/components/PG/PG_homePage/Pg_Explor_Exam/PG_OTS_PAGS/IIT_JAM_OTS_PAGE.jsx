  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: " #000", height: "9vh" }}>
        <h1>IITJAM - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">

          <h2>IITJAM - ONLINE TEST SERIES - 2024</h2>

          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
          IITJAM, or the Joint Admission Test for Masters, is a prestigious exam
          conducted for students aspiring to pursue postgraduate programs in
          various disciplines, including M.Sc., M.Tech, and Ph.D., at renowned
          institutes like the IITs and IISc across India. IITJAM provides
          candidates with an opportunity to delve into advanced degrees in
          subjects such as science, technology, and other related fields. For
          IITJAM aspirants, meticulous preparation and exceptional performance
          in the exam are paramount. The IITJAM Online Test Series provided by
          eGRADTutor academy proves to be an indispensable tool for students. It
          enables them to assess their knowledge and comprehension of subjects
          before confronting the actual entrance examination. Our online test
          series not only reinforces understanding but also presents challenges
          in an environment closely resembling the final IITJAM examination. At
          eGRADTutor academy, we offer a comprehensive set of resources tailored
          specifically for IITJAM aspirants. This includes previous year
          question papers and online test series designed to replicate the
          IITJAM exam interface. This empowers students to strategize and
          approach the examination with confidence. Practicing with our test
          series enhances aspirants' preparation, significantly improving their
          prospects of success in the IITJAM exam and admission to diverse
        ...
        <div className="jeesection">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                IITJAM online test series is crafted by academic experts with
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                IITJAM online test series lets you have a real-time exam
        ...
        <div className="whyonline_ots">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li id="FEATURES-OTS">
              ...
              <p>Developed as per the latest syllabus of IITJAM exam.</p>
            </li>
            <li id="FEATURES-OTS">
              <span className="card2_-img">

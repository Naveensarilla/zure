  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: " #000", height: "9vh" }}>
        <h1>BARC - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">

          <h2>BARC - ONLINE TEST SERIES - 2024</h2>

          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
          BARC, which stands for Bhabha Atomic Research Centre, conducts the
          entrance exam for various scientific and engineering positions. This
          exam is a gateway for candidates aspiring to pursue a career in
          nuclear science, engineering, and research at BARC. The BARC Online
          Test Series offered by eGRADTutor academy proves to be an invaluable
          resource for students, allowing them to assess their knowledge and
          comprehension of subjects before tackling the actual entrance
          examination. Thorough preparation and excellent performance in the
          BARC exam are vital goals for aspirants. At eGRADTutor academy, we
          offer a comprehensive set of resources, including previous year
          question papers and online test series tailored specifically for BARC
          aspirants. The online test series replicates the BARC exam interface,
          empowering students to strategize and approach the examination with
          confidence. Practicing with our test series enhances aspirants'
          preparation, significantly improving their prospects of success in the
          BARC exam and admission to various scientific and engineering programs
          at BARC.
        </p>
      </div>
        ...
        <div className="jeesection">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                BARC online test series is crafted by academic experts with
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                BARC online test series lets you have a real-time exam
        ...
        <div className="whyonline_ots">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li id="FEATURES-OTS">
              ...
              <p>Developed as per the latest syllabus of BARC exam.</p>
            </li>
            <li id="FEATURES-OTS">
              <span className="card2_-img">

  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: " #000", height: "9vh" }}>
        <h1>GATE - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">
          <h2>GATE - ONLINE TEST SERIES - 2024</h2>
          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
        GATE stands for Graduate Aptitude Test in Engineering. It is an online exam conducted for students aspiring to pursue postgraduate programs in engineering, technology, architecture, and science at various esteemed institutes across India. GATE opens doors for candidates to explore M.E., M.Tech, Ph.D., and other advanced degrees in these diverse fields.

        Thorough preparation and excellent performance in the exam are vital goals for aspirants. The GATE Online Test Series offered by eGRADTutor academy proves to be an invaluable resource for students, allowing them to assess their knowledge and comprehension of subjects before tackling the actual entrance examination. Our online test series not only reinforces your understanding but also provides challenges in an environment closely resembling the final GATE examination.

        At eGRADTutor academy, we offer a comprehensive set of resources, including previous year question papers and online test series tailored specifically for GATE aspirants. The online test series replicates the GATE exam interface, empowering students to strategize and approach the examination with confidence. Practicing with our test series enhances aspirants' preparation, significantly improving their prospects of success in the GATE exam and admission to diverse PG programs.
        </p>
      </div>
        ...
        <div className="jeesection">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
              GATE online test series is crafted by academic experts with
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
              GATE online test series lets you have a real-time exam
        ...
        <div className="whyonline_ots">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li id="FEATURES-OTS">
              ...
              <p>
                Developed as per the latest syllabus of GATE exam.
              </p>
            </li>
            <li id="FEATURES-OTS">
              <span className="card2_-img">

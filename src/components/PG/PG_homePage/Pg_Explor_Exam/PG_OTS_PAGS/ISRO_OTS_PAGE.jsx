  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: " #000", height: "9vh" }}>
        <h1>ISRO - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">

          <h2>ISRO - ONLINE TEST SERIES - 2024</h2>

          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
          The ISRO (Indian Space Research Organisation) exam is a prestigious
          assessment for candidates aspiring to contribute to India's space
          exploration endeavors. ISRO conducts exams for various positions, and
          success opens doors to engaging opportunities in the field of space
          research and technology. Diligent preparation and outstanding
          performance in the ISRO exam are crucial objectives for aspirants. The
          ISRO Online Test Series, provided by eGRADTutor academy, serves as a
          valuable resource for candidates. This online test series allows
          individuals to evaluate their knowledge and understanding of relevant
          subjects before facing the actual entrance examination. It not only
          reinforces comprehension but also presents challenges in an
          environment closely resembling the final ISRO examination. At
          eGRADTutor academy, we offer a comprehensive set of resources tailored
          specifically for ISRO aspirants. This includes previous year question
          papers and an online test series designed to replicate the ISRO exam
          interface. Our goal is to empower students to strategize and approach
          the examination with confidence. Through consistent practice with our
          test series, aspirants can enhance their preparation, significantly
          improving their chances of success in the ISRO exam and securing
          opportunities in the dynamic field of space research and technology.
        </p>
      </div>
        ...
        <div className="jeesection">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                ISRO online test series is crafted by academic experts with
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                ISRO online test series lets you have a real-time exam
        ...
        <div className="whyonline_ots">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li id="FEATURES-OTS">
              ...
              <p>Developed as per the latest syllabus of ISRO exam.</p>
            </li>
            <li id="FEATURES-OTS">
              <span className="card2_-img">

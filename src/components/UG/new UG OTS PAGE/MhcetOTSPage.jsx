  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: "#000", height: "9vh" }}>
        <h1>MHCET - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">
          <h2>MHCET - ONLINE TEST SERIES - 2024</h2>
          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
          MHCET stands for Maharashtra Common Entrance Test. It is a
          computer-based examination conducted for students seeking admission
          into various undergraduate programs, including Engineering, Medicine,
          and Agriculture, offered at different campuses in Maharashtra.
          Aspirants aspire to prepare thoroughly and perform well in this
          entrance examination to fulfill their academic goals. To assist
          students in their preparation journey, MHCET Online Test Series is
          designed to evaluate their learning and comprehension levels before
          facing the actual entrance exam. Our online test series serves as a
          platform for students to strengthen their understanding of the
          subjects and test their knowledge in an environment closely resembling
          the final examination. eGRADTutor Academy is committed to supporting
          MHCET aspirants by providing access to previous year question papers
          and comprehensive online test series. The test series interface
          mirrors the actual exam setup, empowering students to develop
          effective strategies and approach the examination with confidence.
          Join our academy to enhance your preparation, challenge yourself, and
          achieve success in the MHCET. Additionally, MHCET offers admission to
          various courses to help students realize their academic aspirations.
        </p>
      </div>
        ...
        <div className="jeesection">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                MHCET online test series is crafted by academic experts with
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                MHCET online test series lets you have a real-time exam
        ...
        <div className="whyonline_ots">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li id="FEATURES-OTS">
              ...
              <p>Developed as per the latest syllabus of MHCET exam.</p>
            </li>
            <li id="FEATURES-OTS">
              <span className="card2_-img">

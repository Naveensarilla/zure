...
// ------------------------about css -------------------------------------
import "./about.css";
// import OUR_MISSION from '../../../PG/Images/OUR_VISION1.png'
// import OUR_VISION from '../../../PG/Images/OUR_VISION2.png'
...
const About = () => {
  return (
    <div id='about_' style={{background:'rgb(255, 247, 247)',paddingTop:'5px'}}>
      ...
      {AboutData.map((AboutData, index) => {
        return (
          <div className='about_container' key={index}>
             <h2 style={{color:'rgb(231 144 144)'}}>{AboutData.about_title}</h2>
           ...
           <div className='about_left_container'>
              ...
              <div className="about_left_inf">
                <p style={{fontSize:'20px'}}>{AboutData.about_info}</p>
              </div>
            </div>
            ...
            <div className='about_right_container'>
              <div className='about_vision_box_contant'>
                <div className='about_vision_-subbox'>
                  ...
                  <h3 style={{color:'rgb(97, 97, 97)'}}>{AboutData.about_box_title1}</h3>
              ...
              <div className='about_vision_box_contant'>
                <div className='about_mision_-subbox'>
                  ...
                  <h3 style={{color:'rgb(97, 97, 97)'}}>{AboutData.about_box_title2}</h3>

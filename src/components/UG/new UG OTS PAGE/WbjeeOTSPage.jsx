  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: "#000", height: "9vh" }}>
        <h1>WBJEE - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">
          <h2>WBJEE - ONLINE TEST SERIES - 2024</h2>
          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
          WBJEE stands for West Bengal Joint Entrance Examination. It is a
          state-level entrance examination conducted for students seeking
          admission into various undergraduate programs, including
          Engineering/Technology, Pharmacy and Architecture, offered at
          different campuses in West Bengal. Aspirants aim to prepare thoroughly
          and perform well in this entrance examination to fulfill their
          academic goals. To assist students in their preparation journey, WBJEE
          Online Test Series is designed to evaluate their learning and
          comprehension levels before facing the actual entrance exam. Our
          ...
          Academy is committed to supporting WBJEE aspirants by providing access
          to previous year question papers and comprehensive online test series.
          The test series interface mirrors the actual exam setup, empowering
          students to develop effective strategies and approach the examination
          with confidence. Join our academy to enhance your preparation,
          challenge yourself, and achieve success in the WBJEE, gaining
          admission to your desired undergraduate programs.
        </p>
      </div>
        ...
        <div className="jeesection">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                WBJEE online test series is crafted by academic experts with
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                WBJEE online test series lets you have a real-time exam
        ...
        <div className="whyonline_ots">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li id="FEATURES-OTS">
              ...
              <p>Developed as per the latest syllabus of WBJEE exam.</p>
            </li>
            <li id="FEATURES-OTS">
              <span className="card2_-img">

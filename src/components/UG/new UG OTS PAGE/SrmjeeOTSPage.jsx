  ...
  return (
    <>
      ...
      <div className="otsh1" style={{ background: "#000", height: "9vh" }}>
        <h1>SRMJEE - ONLINE TEST SERIES</h1>
      </div>
      <div className="jeesection">
        <div className="jeediv">
          <h2>SRMJEE - ONLINE TEST SERIES - 2024</h2>
          {/* <a href="">COURSE BROCHURE</a> */}
        </div>

        <p className="jeesection_paragraph">
          SRMJEE stands for SRM Joint Engineering Entrance Examination. It is a
          computer-based examination conducted for students seeking admission
          into various undergraduate programs, including BTech, offered at
          different campuses in SRM University. Aspirants aim to prepare
          ...
          SRMJEE Online Test Series is designed to evaluate their learning and
          ...
          environment closely resembling the final examination. SRM University
          is committed to supporting SRMJEE aspirants by providing access to
          previous year question papers and comprehensive online test series.
          ...
          challenge yourself, and achieve success in the SRMJEE. Additionally,
          SRMJEE offers various undergraduate programs for students to pursue
        ...
        <div className="jeesection">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                SRMJEE online test series is crafted by academic experts with
            ...
            <li style={{ alignItems: "center" }}>
              ...
              <p>
                SRMJEE online test series lets you have a real-time exam
        ...
        <div className="whyonline_ots">
          ...
          <ul className="FEATURES_-contant">
            ...
            <li id="FEATURES-OTS">
              ...
              <p>Developed as per the latest syllabus of SRMJEE exam.</p>
            </li>
            <li id="FEATURES-OTS">
              <span className="card2_-img">
